...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        ...
        appBar: AppBar(
          title: Text('Alter.', style: TextStyle(fontSize: 24, letterSpacing: -1.0, fontWeight: FontWeight.bold, color: Colors.tealAccent[700])),
          centerTitle: true,
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Image.asset('assets/images/01.png',width: 400),
                      ],
                    ),
                  ),
                ],
                  ...
                  Container(
                      ...
                      child: Material(
                        ...
                        child: GestureDetector(
                          onTap: () { Navigator.of(context).pushNamed('/dash'); },
                          child: Center(
                            child: Text(
                              'LOGIN',
                              style: TextStyle(
